...
import { buildBaby, buildBabyRepository, buildMilestone, buildMilestoneRepository } from './milestone-test-helpers';
...
describe('DeleteMilestoneUseCase', () => {
  it('deletes the milestone when the baby belongs to the requesting user', async () => {
    ...
    const useCase = new DeleteMilestoneUseCase(babyRepository, milestoneRepository);
